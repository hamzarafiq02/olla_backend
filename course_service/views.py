...
from .models import Course, Review, Module, Lesson, Tag, TagModule, Quiz
...
class ModuleView(AutoPrefetchViewSetMixin, viewsets.ModelViewSet):
    ...
    def get_permissions(self):
        ...
        permission_classes = [
            ...
            custom_permissions.IsCourseInstructor,
        ]
    ...
    def perform_create(self, serializer):
        ...
        if course.instructor != course_instructor:
            raise serializers.ValidationError(
                {
                    "detail: ": "You can only create modules for courses that you are an instructor of."
                }
            )
...
class LessonView(AutoPrefetchViewSetMixin, viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        if course.instructor != course_instructor:
            raise serializers.ValidationError(
                "You cannot create a new lesson for a module that belongs to a course you are not an instructor of."
            )
