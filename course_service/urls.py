...
urlpatterns = [
    ...
    path("<str:pk>/update/", views.CourseViewSet.as_view({'put': 'update'}), name="course-update"),
    path("<str:pk>/delete/", views.CourseViewSet.as_view({'delete': 'destroy'}), name="course-delete"),
